	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusstechanxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discusstechanxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discusstechanxinxi`, this.ruleForm);
				}

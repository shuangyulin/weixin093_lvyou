  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">南宁周边乡村游小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='youke'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='youke'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='youke'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='youke'">
